...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(201).to({_off:false},0).wait(1).to({regX:60.7,regY:14.1,x:77.4,y:372.2,alpha:0.125},0).wait(1).to({x:85.1,alpha:0.25},0).wait(1).to({x:92.8,alpha:0.375},0).wait(1).to({x:100.5,alpha:0.5},0).wait(1).to({x:108.2,alpha:0.625},0).wait(1).to({x:115.9,alpha:0.75},0).wait(1).to({x:123.6,alpha:0.875},0).wait(1).to({x:131.3,alpha:1},0).wait(30));
